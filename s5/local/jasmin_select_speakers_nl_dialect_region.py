...
# Example of use:
# python3 jasmin_select_speakers_nl_dialect_region.py data/local/data/spk2dialectregion_nl N1 data/local/data/spklist_N1_nl.txt
...
#            print(line_input.strip())
            ...
            if line_input.strip().split('\t')[1].startswith(propert) :
